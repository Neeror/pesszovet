function adjustFooterPosition() {
  const main = document.getElementById('mapInner');
  const footer = document.querySelector('.space');
  
  if (main && footer) {
      const mainHeight = main.offsetHeight;
      const mainTop = main.offsetTop;
      footer.style.marginTop = (mainHeight + mainTop + 50) + "px";
  }
}
...
if (document.getElementById('mapImage')) {
  document.getElementById('mapImage').onload = adjustFooterPosition;
}
